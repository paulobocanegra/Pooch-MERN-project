            ...
            <div className= "Nav-bar">
                ...
                <div className="Hero-banner">
                    ...
                    <div className="Call-to-action">
                        <div className="Text-wrapper1">
                            ...
                            <h4 className="Hook-text">sign up for pooch to start socializing your dog and meet other dog lovers like you!</h4>
                        </div>
                ...
                <div className="Learn-more-section">
                    <div className="Learn-more-child">
                        <img className ="Learn-more-image" src="./dog_and_comp.png" alt=""/>
                        <h5 className="Learn-more-text">Get advice from other dog lovers about the best product for your pup!</h5>
                        <button className="Learn-more-button">Learn More</button>
                    </div>
                    <div className="Learn-more-child">
                        <img className="Learn-more-image" src="./phone_and_dog.png" alt=""/>
                        <h5 className="Learn-more-text">Connect with other dog lovers and get you pup the socialization they need!</h5>
                        <button className="Learn-more-button">Learn More</button>
                    </div>
                    <div className="Learn-more-child">
                        <img className="Learn-more-image" src="./friend_dog.png" alt=""/>
                        <h5 className="Learn-more-text">Socialize your dog and meet new people along the way!</h5>
                        <button className="Learn-more-button">Learn More</button>
                    </div>
                </div>
